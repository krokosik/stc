<template>
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
        <svg xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 300 300" preserveAspectRatio="xMidYMid meet" class="w-10 h-10 custom-svg">
        ...
        <span class="self-center text-2xl font-semibold base-text-color whitespace-nowrap">Library STC</span>
      </a>
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <a href="#/help/replication" class="flex items-center justify-between w-full py-2 px-3 custom-link rounded md:border-0 md:p-0 md:w-auto">
              <span class="md:hidden">Replication&nbsp;</span>
              <document-duplicate-icon class="h-6 w-6"/>
            </a>
          </li>
          <li>
            <a href="#/help/intro" class="flex items-center justify-between w-full py-2 px-3 custom-link rounded md:border-0 md:p-0 md:w-auto">
  ...
  import {Bars3Icon, DocumentDuplicateIcon, QuestionMarkCircleIcon} from "@heroicons/vue/24/outline";
  </script>
